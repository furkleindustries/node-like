...
export abstract class AbstractElementLike extends MParentNodeLike(MChildNodeLike(<TConstructor<AbstractNodeLike>>AbstractNodeLike.constructor)) implements IElementLike {
  abstract nodeType:                        1;
