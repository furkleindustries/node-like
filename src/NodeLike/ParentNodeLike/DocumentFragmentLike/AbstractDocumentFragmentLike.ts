...
export abstract class AbstractDocumentFragmentLike extends MParentNodeLike(<TConstructor<AbstractNodeLike>>AbstractNodeLike.constructor) implements IDocumentFragmentLike {
