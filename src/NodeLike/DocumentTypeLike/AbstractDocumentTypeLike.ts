...
export abstract class AbstractDocumentTypeLike extends MChildNodeLike(<TConstructor<AbstractNodeLike>>AbstractNodeLike.constructor) implements IDocumentTypeLike {
